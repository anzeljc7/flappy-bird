class Pipe extends SpriteRenderer {
    constructor(path, sX1, sY1, sX2, sY2, sWidth, sHeight, dWidth, dHeight, pipeSpace) {
        ...
        this.space = pipeSpace;    //koliko prostora je med pipama

        this.maxPosY = -160; //max pozicija, do katere lahko gre gor gornja pipa
    }
